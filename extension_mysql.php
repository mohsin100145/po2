...
$result = $conn->query("SELECT phones.id, phones.username, districts.name AS district, divisions.name AS division, phones.thana, phones.incharge, phones.duty_officer, phones.oc, phones.address, phones.secret, phones.accountcode, phones.callerid, phones.mailbox, phones.context, phones.type, phones.host, phones.remarks
FROM phones
